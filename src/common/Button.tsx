...
export const ButtonDelete = ({ children, onClick } : { children: string, onClick?: MouseEventHandler<HTMLButtonElement>}) => {
  return (
      <button
        onClick={onClick}
        className="inline-flex items-center leading-4 px-4 py-2 rounded border border-red-600 shadow-sm text-sm text-red-600 bg-white hover:bg-gray-50 font-medium rounded-mdfocus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
        >
