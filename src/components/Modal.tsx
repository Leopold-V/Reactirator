    ...
    return (
        <div className="absolute w-screen h-screen flex justify-center items-center top-0 left-0">
            ...
            <div className="bg-white rounded z-50 flex flex-col justify-center items-center p-6 lg:w-1/3">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className={`icon icon-tabler icon-tabler-settings ${loading ? 'animate-spin-slow' : ''}`} width="130" height="130" viewBox="0 0 24 24" strokeWidth="1.5" stroke="black" fill="none" strokeLinecap="round" strokeLinejoin="round">
