...
export const FormCustomProject = ({
  ...
  return (
    <div className="bg-gradient-to-br from-purple-400 to-purple-700 text-gray-700 dark:bg-blueGray p-6 rounded shadow hover:shadow-lg transition duration-200">
