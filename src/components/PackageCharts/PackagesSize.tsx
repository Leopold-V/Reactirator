...
export const PackagesSize = ({
  ...
  return (
    <div className="bg-white dark:bg-blueGray w-56 dark:text-white rounded shadow p-6 flex flex-col justify-start items-center hover:shadow-lg transition duration-200">
