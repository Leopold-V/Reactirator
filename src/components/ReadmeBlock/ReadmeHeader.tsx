...
export const ReadmeHeader = ({ tab, setTab }: { tab: string; setTab: (tab: string) => void }) => {
  ...
  return (
    <div className="flex justify-between items-center">
      <h1 className="font-extrabold text-gray-700 text-xl text-center py-4 pl-2 md:pl-0">
        Readme.md
      </h1>
      <div className="space-x-1">
        <button
          className={`hover:bg-gray-50 focus:outline-none hover:text-indigo-600 border-b-4 border-transparent focus:border-indigo-600
                ${
