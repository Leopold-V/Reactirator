...
export const ItemPackage = ({type, packageName, index, dispatchPackages}:
    ...
    return (
        <Draggable draggableId={packageName} index={index} key={packageName}>
            ...
            >
                <ButtonRemovePackage type={type} packageName={packageName} dispatchPackages={dispatchPackages} />
