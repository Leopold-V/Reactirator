...
import { getToken, createRepo } from '../../services/github.services';
...
export const GithubSection = ({token, setToken } : { token: string, setToken: (token: string) => void}) => {
  ...
  return (
    <form className="text-center">
      <input className="input my-2" type="text" name="repo_name" placeholder="repo name" />
      <div className="my-2 space-y-3 space-x-4">
        <h3>Enabled auto project push in the github repo ?</h3>
        <div>
          <input type="radio" id="yes" name="push" value="yes"
            checked />
