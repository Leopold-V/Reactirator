...
export const ButtonRemovePackage = ({type, packageName, dispatchPackages}: 
    {type: 'dependencies' | 'devDependencies', packageName: string, dispatchPackages: Dispatch<actionPackageType> }) => {
