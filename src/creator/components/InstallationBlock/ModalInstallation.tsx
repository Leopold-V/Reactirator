          ...
          >
            <div className="relative w-1/2 inline-block bg-white rounded overflow-hidden shadow-xl transform transition-all align-middle">
              <div className="flex flex-col justify-center items-center">
                ...
                <div
                  className="rounded overflow-auto h-80 my-6 w-3/4"
                  style={{ backgroundColor: '#2e3748' }}
                >
                  <ConsoleLogs />
                </div>
              </div>
...
/*
    <div className="w-full fixed h-full flex justify-center items-center top-0 left-0">
      <div className="absolute bg-gray-700 opacity-60 w-screen h-screen top-0 left-0"></div>
      <div className="fixed mx-auto bg-white rounded z-50 flex flex-col justify-center items-center p-6 w-2/5">
        ...
        <div className="bg-black rounded overflow-auto h-80 my-6 w-full">
          <ConsoleLogs />
        </div>
        {loading ? (
          <button
