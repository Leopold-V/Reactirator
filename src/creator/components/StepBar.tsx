            ...
            {step.status === 'complete' ? (
              <>
                ...
                <Link to={step.href} className="relative flex flex-col justify-start group">
                  ...
                  <span className="w-full absolute -bottom-6 flex flex-col">
              ...
              <>
                ...
                >
                  <span className="w-12 h-9 flex items-center">
                    <span className="relative z-10 w-8 h-8 flex items-center justify-center bg-white border-2 border-indigo-600 rounded-full group-hover:bg-gray-50">
              ...
              <>
                ...
                <Link to={step.href} className="relative flex flex-col justify-start group">
                  <span className="w-12 h-9 flex items-center">
                    <span className="relative z-10 w-8 h-8 flex items-center justify-center bg-white border-2 border-gray-300 rounded-full group-hover:bg-gray-50"></span>
                  </span>
