      ...
      <div>
        ...
        <ul className="nav__list">
          <li className="nav__item">
            <Link
              className={`nav__link ${location.pathname === '/creator' ? 'active' : ''}`}
              to="/creator"
            >
              <svg
          ...
          <li className="nav__item">
            <Link
              className={`nav__link ${location.pathname === '/creator/packages' ? 'active' : ''}`}
              to="/creator/packages"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li className="nav__item">
            <Link
              className={`nav__link ${
                location.pathname === '/creator/documentation' ? 'active' : ''
              }`}
          ...
          <li className="nav__item">
            <Link
              className={`nav__link ${location.pathname === '/creator/command' ? 'active' : ''}`}
              to="/creator/command"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li className="nav__item">
            <Link
              className={`nav__link ${
                location.pathname === '/creator/architecture' ? 'active' : ''
              }`}
